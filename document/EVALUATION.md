...
the final query as a DetPO-style annotator-instructions block; support
questions retain the baseline format. This is inference-time only and does
not modify the model or training data. Episode records may alternatively carry a
